													...
													<ul class="scrum-group">
														...
														<li class="scrum-item back-log">
															...
															<div class="scrum-body p-t-5 p-b-10">
																<img src="<?php echo base_url('assets/img/user.png'); ?>" alt="" class="img-circle" />
																<img src="<?php echo base_url('assets/img/user.png'); ?>" alt="" class="img-circle" />
																<img src="<?php echo base_url('assets/img/user.png'); ?>" alt="" class="img-circle" />
															</div>
															...
															<div class="card image-over-card">
																<div class="card-image">
																	<a href="javascript:vodi(0)">
																		<img src="<?php echo base_url('assets/img/user.png'); ?>assets/img/gallery/full/full-11.jpg">
																	</a>
																</div>
																<div class="card-body">
															...
															<div class="card image-over-card">
																<div class="card-image">
																	<a href="javascript:void(0)">
																		<img src="<?php echo base_url('assets/img/user.png'); ?>assets/img/gallery/full/full-13.jpg">
																	</a>
																</div>
																<div class="card-body">
														...
														<div class="card-body clear-both p-0 max-h-500 scrollbar">
															...
															<ul class="list-group p-0">
																<li class="list-group-item border-top p-t-20 p-b-20">
																	<span class="pull-left"><img src="<?php echo base_url('assets/img/user.png'); ?>" alt="" class="img-circle max-w-50 m-r-10"></span>
																	<div class="list-group-item-body">
