   <div id="" class="header-md ecom-header">
                      ...
                      <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><img src="12252_Tgi0.jpeg" alt="" class="img-thumbnail" /></td>
                            <td>Grunt</td>
                            <td>#394822</td>
                            <td>$32</td>
                            <td>
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                      <div class="edit_product_img min-h-200">
                        <div><img src="39_Ie8T.jpeg" alt=""></div>
                        <div><img src="39_8wMD.jpeg" alt=""></div>
                        <div><img src="39_JnFC.jpeg" alt=""></div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body p-0">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fadeIn" id="product_add_images">
                  <div class="card card p-20 p-t-10 m-b-0">
                    <div class="card-body">
                      <form action="<?php echo base_url('admin/upload_image'); ?>" class="dropzone" id="myAwesomeDropzone" enctype="multipart/form-data"></form>
                    </div>
                  </div>
                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group label-floating is-empty">
                              <div class="input-group">
                                <span class="input-group-addon">$</span>
                                <label class="control-label">Compare at price</label>
                                <input type="text" class="form-control product_compare">
                              </div>
                            </div>
                          </div>
                          <div class="col-xs-12">
                            <div class="form-group">
                              <div class="togglebutton m-b-15 ">
                                <label>
                                  <input type="checkbox" class="toggle-info product_status" checked>   Charge taxes on this product
                                </label>
                              </div>
                            </div>
                          </div>
                      ...
                      <form>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group label-floating is-empty">
                              <label class="control-label">SKU (Stock Keeping Unit)</label>
                              <input type="text" class="form-control product_sku">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group label-floating is-empty">
                              <label class="control-label">Barcode (ISBN, UPC, GTIN, etc.)</label>
                              <input type="text" class="form-control product_barcode">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="" class="control-label">Inventory policy</label>
                              <select class="select form-control product_inventory">
                                <option selected>Don't track inventory</option>
                                <option>Track this product's inventory</option>
                              </select>
                            </div>
                      ...
                      <form>
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group label-floating is-empty">
                              <label class="control-label">Width</label>
                              <input type="text" class="form-control product_width">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group label-floating is-empty">
                              <label class="control-label">Height</label>
                              <input type="text" class="form-control product_height">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group label-floating is-empty">
                              <label class="control-label">Depth</label>
                              <input type="text" class="form-control product_depth">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group label-floating is-empty">
                              <div class="input-group">
                                <label class="control-label">Weight</label>
                                <input type="text" class="form-control product_weight" aria-label="...">
                                <div class="input-group-btn suffix-select">
                                  <select class="select form-control product_unit">
                                    <option>lb</option>
                                    <option>kg</option>
                                  </select>
                                </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group label-floating is-empty">
                              <div class="input-group">
                                <span class="input-group-addon">$</span>
                                <label class="control-label">Extra Shipping Fee</label>
                                <input type="text" class="form-control product_shipping">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <!-- modal-content -->
              <!-- ajax loader -->
               <div class="form-loader product-loader">
                <div class="preloader pl-lg pls-green">
             ...
             <!--  <p class="text-center"><span class="alert alert-danger">PLease fix the error</span></p> -->
          </div>
          <!-- modal-dialog -->
        </div>